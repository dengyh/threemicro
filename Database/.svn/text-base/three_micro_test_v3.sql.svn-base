...
(1, '1758圣诞舞会', '三饭小广场', 'first', 'east', 'publicWelfare', '软件学院', '<!DOCTYPE html>\r\n<html>\r\n<head>\r\n</head>\r\n<body>\r\n<p><img src="//media/upload/20140730145722grid.jpg" /></p>\r\n</body>\r\n</html>', 'dengyh7', 'pml', 0, 50, '2014-07-30 16:00:00', '2014-08-07 16:00:00', '2014-08-13 16:00:00', '2014-07-30 07:00:04', '01:30:00', 0, 0, NULL, NULL);
...
INSERT INTO `activity_submission` (`id`, `description`, `file`, `activity_id`) VALUES
(1, 'Java初级教程', 'files/Java初学者实践教程.pdf', 1);
...
(9, 'pbkdf2_sha256$10000$EN1iTb06eA0e$EuSgQPlqLhcDHiiyS/JLB5FhvMT3ZLJtlc+RqBv/IZM=', '2014-07-30 07:09:45', 0, 'pml', 'teacher', 'pml', '', 0, 1, '2014-07-25 11:08:15'),
...
(20, 'pbkdf2_sha256$10000$gH2I3FHmK6Hr$9Y5MU+IxVcnhtmRTvJc8zcKvezfmDYUGjfr56Mdfw2c=', '2014-07-30 05:51:21', 0, 'dengyh7', 'student', '', '', 0, 1, '2014-07-30 05:51:20');
...
('gieoua7upz4icj43etyi1fdet5y9ukf8', 'Y2VlOTY4YjFjZGRhNzAyNGM5ODY2MTJkNjhkYzQzMGQ5ZjQ3OGNiNzqAAn1xAShVEl9hdXRoX3VzZXJfYmFja2VuZHECVSlkamFuZ28uY29udHJpYi5hdXRoLmJhY2tlbmRzLk1vZGVsQmFja2VuZHEDVQ1fYXV0aF91c2VyX2lkcQSKAQl1Lg==', '2014-08-13 07:09:46'),
('nh7zu214zmn3c2hkmfd7356npgbaqobw', 'NDRjNWM4NTNiMWYyODdhMjRjYjEwZTVlNjk4YmNhMWM1MTM0NWNhOTqAAn1xAS4=', '2014-08-13 07:09:17');
...
INSERT INTO `student_student` (`netid`, `name`, `email`, `phone`, `user_id`, `registTimes`, `completeTimes`, `totalTime`, `lastTime`, `lastLastTime`) VALUES
('dengyh7', '宇恒 邓', 'dengyh7@mail2.sysu.edu.cn', '', 20, 0, 0, '0.0', '2013-12-31 16:00:00', '2013-12-31 16:00:00');
